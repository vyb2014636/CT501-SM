  ...
  return (
    <Grid container spacing={3} mt={3}>
      ...
      <Grid item xs={12} sm={6} md={3}>
        <Card sx={{ padding: 3, bgcolor: '#0088FE', color: '#fff' }}>
      ...
      {/* New Users */}
      <Grid item xs={12} sm={6} md={3}>
        <Card sx={{ padding: 3, bgcolor: '#00C49F', color: '#fff' }}>
      ...
      {/* Total Posts */}
      <Grid item xs={12} sm={6} md={3}>
        <Card sx={{ padding: 3, bgcolor: '#FFBB28', color: '#fff' }}>
      ...
      {/* Banned Users */}
      <Grid item xs={12} sm={6} md={3}>
        <Card sx={{ padding: 3, bgcolor: '#FF8042', color: '#fff' }}>
